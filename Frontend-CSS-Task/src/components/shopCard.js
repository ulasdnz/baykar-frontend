...
const ShopCard = ({ image, children }) => {
  return (
    <div
      className="w-[395px] max-sm:w-[100%] relative bg-blue_gray z-10
    ...
    >
      <div>
        <img
          className="w-full border-solid border-[1px] border-blue_gray rounded-t-[10px] object-contain"
          src={image}
          alt="shoes"
        ></img>
      </div>
      <div className="p-8 relative bg-blue_gray z-10">
        <div className="text-2xl font-bold	">
          Title
        </div>
        <div className="text-[18px]  bg-blue_gray relative pt-4 z-10" >
          Egestas elit dui scelerisque ut eu purus aliquam vitae habitasse.
        </div>
      </div>
      <div className="pb-8 px-8 bg-blue_gray">
        <div className="p-4 flex relative items-center justify-center border-2 border-solid rounded-[8px]">
          <svg
